...
const Page = () => {
  ...
  const { mutate: signIn, isPending: isLoading } = trpc.auth.login.useMutation({
    onSuccess: async () => {
  ...
  return (
    <div className="container relative flex flex-col pt-20 items-center justify-center lg:px-0 mx-auto">
            ...
            <div className="grid gap-2">
              <div className="grid gap-1 py-2">
                ...
                <Input
                  type="email"
                  {...register("email")}
                  className={cn("focus-visible:ring-orange-300 focus-visible:ring-offset-0", {
                    "focus-visible:ring-destructive": errors.email,
                  })}
              ...
              <div className="grid gap-1 py-2">
                ...
                <Input
                  ...
                  {...register("password")}
                  className={cn("focus-visible:ring-orange-300 focus-visible:ring-offset-0", {
                    "focus-visible:ring-destructive": errors.password,
                  })}
                  placeholder="********"
                />
